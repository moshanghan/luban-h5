...
export default {
  ...
  computed: {
    ...
    methodQueue () {
      return (this.editingElement && this.editingElement.methods) || []
    }
  },
  data: () => ({
    // methodQueue: [],
    ...
    renderForm (methodOption) {
      return (
        <a-form layout="horizontal">
          <a-form-item label={this.$t('editor.editPanel.method.type')} labelCol={{ span: 5 }} wrapperCol={{ span: 16, offset: 2 }}>
          ...
          <a-form-item label={this.$t('editor.editPanel.method.delay')} labelCol={{ span: 5 }} wrapperCol={{ span: 16, offset: 2 }} style="margin-bottom:0;">
            <a-form-item style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}>
              <a-slider
                defaultValue={2}
                min={0}
          ...
          <a-form-item label={this.$t('editor.editPanel.method.iteration')} labelCol={{ span: 5 }} wrapperCol={{ span: 16, offset: 2 }} style="margin-bottom:0;">
            <a-form-item style={{ display: 'inline-block', width: 'calc(50% - 12px)' }}>
              <a-slider
                defaultValue={2}
                min={0}
          ...
          <a-form-item label={this.$t('editor.editPanel.method.inifinite')} labelCol={{ span: 5 }} wrapperCol={{ span: 16, offset: 2 }} style="margin-bottom:0;">
            <a-switch
